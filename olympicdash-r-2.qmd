...
Due to Word War II, no olympic games were held in 1940 and 1944.
...
```{r}
#| label: summer-calculate-most-metals
...
Teams sorted in descending order of metals.
...
Teams sorted in ascending order of metals.
...
```{r}
#| label: winter-calculate-most-metals
